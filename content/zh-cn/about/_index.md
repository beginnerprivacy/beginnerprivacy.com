---
title: 关于
description: 了解更多关于 Beginner Privacy 的信息，我们的使命是提升在线安全，以及您如何能为我们的社区做出贡献。加入我们，让每个人都能更轻松地保障隐私，并让互联网变得更安全。
---
...
- **工具**：易于使用的工具，增强您的在线隐私、安全性和匿名性。
- **新闻**：随时了解最新的隐私和安全动态。  
- **社区**：加入我们活跃的[社区](/zh-cn/about/join-simplex-group)，分享技巧、提问并与他人建立联系。

### 语言
Beginner Privacy 目前提供三种语言：
- 英语  
- 西班牙语  
- 简体中文

这三种语言是[世界上最广泛使用的语言](https://en.wikipedia.org/wiki/List_of_languages_by_total_number_of_speakers#Ethnologue_(2025))，这也是我们选择支持它们的原因。我们的目标是使网站尽可能可访问，同时保持可管理的维护工作——这也是我们目前不提供其他语言的原因。

#### 想要其他语言的版本？  
没问题！如果你使用的是 **Brave** 或 **Firefox**，你可以利用它们出色的内置翻译功能：
- **Brave**: 点击菜单 (⋮) → **翻译此页面**
