...
{{< checklists/item link="/articles/break-free-from-proprietary-software-with-foss" text="仅使用自由开源软件可以降低专有代码中隐藏监视的风险。" id="only-use-foss" >}}仅使用 FOSS{{< /checklists/item >}}
...
{{< checklists/item link="/articles/cryptocurrency-and-anonymity-a-guide-to-buying-things-without-a-trace" text="使用现金或加密货币进行购买，以最小化财务跟踪并增强交易匿名性。" id="only-buy-with-cash-or-cryptocurrency" >}}仅使用现金或加密货币购买{{< /checklists/item >}}