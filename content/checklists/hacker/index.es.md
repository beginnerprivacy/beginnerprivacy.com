...
excludeSearch: true
---
{{< checklists/item text="Usar un sistema operativo seguro es esencial para proteger tu identidad mientras participas en actividades de alto riesgo como el hacking." id="use-a-secure-operating-system" >}}Usa un sistema operativo seguro{{< /checklists/item >}}
