...
<div class="faq-container">
  ...
  {{< tools/faq-item question="How does this IP address lookup work?" answer="We use [ipify](https://ipify.org) to look up your IP address and [ipapi](https://ipapi.co) to get location details such as latitude and longitude." >}}
</div>